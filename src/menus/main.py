        ...
        if choice <= len(player.relations):
            ...
            if choice == _("Spend time"):
                ...
                if relation.asked_for_money >= 3:
                    ...
                    if relation.asked_for_money == 0 and x_in_y(
                        relation.generosity, 35
                    ):
                        amount = (
                            5 ** (relation.money / 22)
                            * (relation.generosity / 100) ** 2
                ...
                if not relation.was_complimented:
                    ...
                    roll = randint(1, 300)
                    cmp = round_stochastic(appreciation * relation.relationship / 50)
                    if roll <= cmp:
                        compliment = random.choice(COMPLIMENTS)
                        display_event(
                            _(
                ...
                if already_pregnant:
                    ...
                    if x_in_y(fertility, 100):
                        ...
                        choice = choice_input(_("Keep the baby"), _("Get an abortion"))
                        ...
                        if choice == 1:
                            if x_in_y(overrule_chance, 100):
                                ...
                                if player.partner.gender == Gender.Female:
                                    ...
                                    msg = _(
                                        "Your {partner} forced you to get an abortion!"
                                    )
                            ...
                            if x_in_y(overrule_chance, 100):
                                if player.partner.gender == Gender.Female:
                                    msg = _(
                                        "Your {partner} refused to get an abortion!"
                                    )
                                else:
                                    msg = _(
                                        "Your {partner} forced you to keep the baby!"
                                    )
                                display_event(msg.format(partner=rel))
                ...
                if (
                    relation.asked_renew_vows
                    or player.age - relation.last_renew_vows < 10
                    or relation.relationship < randint(40, 70)
                ):
                    print(
                        _(
                            "Your {partner} doesn't want to renew your wedding vows."
                        ).format(partner=partner)
                    )
                    relation.change_relationship(-randint(4, 8))
                    ...
                    print(
                        _("You and your {partner} renewed your wedding vows.").format(
                            partner=partner
                        )
                    )
